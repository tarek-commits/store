<template>
  ...
  <div class="row g-5 g-xl-8">
    <div class="col-xl-4">
      <StatisticsWidget4
        widget-classes="card-xl-stretch mb-xl-8"
        height="150px"
        :svg-icon="getAssetPath('media/icons/duotune/ecommerce/ecm002.svg')"
        color="info"
    ...
    <div class="col-xl-4">
      <StatisticsWidget4
        widget-classes="card-xl-stretch mb-xl-8"
        height="150px"
        :svg-icon="getAssetPath('media/icons/duotune/general/gen025.svg')"
        color="success"
    ...
    <div class="col-xl-4">
      <StatisticsWidget4
        widget-classes="card-xl-stretch mb-5 mb-xl-8"
        height="150px"
        :svg-icon="getAssetPath('media/icons/duotune/finance/fin006.svg')"
        color="primary"
  ...
  <div class="row g-5 g-xl-8">
    ...
    <div class="col-xl-4">
      <StatisticsWidget5
        widget-classes="card-xl-stretch mb-xl-8"
        :svg-icon="getAssetPath('media/icons/duotune/ecommerce/ecm008.svg')"
        color="primary"
        icon-color="white"
        title="Appartments"
    ...
    <div class="col-xl-4">
      <StatisticsWidget5
        widget-classes="card-xl-stretch mb-5 mb-xl-8"
        :svg-icon="getAssetPath('media/icons/duotune/graphs/gra005.svg')"
        color="success"
        icon-color="white"
        title="Sales Stats"
  ...
  <div class="row g-5 g-xl-8">
    <div class="col-xl-3">
      <StatisticsWidget5
        widget-classes="card-xl-stretch mb-xl-8"
        :svg-icon="getAssetPath('media/icons/duotune/general/gen032.svg')"
        color="white"
        icon-color="primary"
        title="500M$"
    ...
    <div class="col-xl-3">
      <StatisticsWidget5
        widget-classes="card-xl-stretch mb-xl-8"
        :svg-icon="getAssetPath('media/icons/duotune/graphs/gra007.svg')"
        color="info"
        icon-color="white"
        title="$50,000"
        description="Milestone Reached"
